...
namespace Castle
{
    ...
    internal class Room
    {
        ...
        public int GetNextRoom(Direction roomDirection)
        {
            ...
            if(index >= 0)
            {
                ...
                return int.Parse(numericValues.ToString(), CultureInfo.CurrentCulture);
            }
            else
            {
                return -1;
        ...
        public void ReplaceMapPoint(Collection<ReplacementPoint> replacements)
        {
            this.replacementPoints.Clear();
            this.replacementPoints = replacements;
        }
    ...
    internal class RoomWarp
    {
        ...
        public RoomWarp(int destinationRoomId, int x, int y, UserMessage userMessage)
        {
    ...
    internal class Door
    {
        ...
        public Door(Collection<Point> doorPoints, Collection<Point> unlockPoints)
        {
            Locked = true;
    ...
    internal class Trap
    {
        ...
        public Trap(Collection<Point> triggerPoints, Collection<Point> wallPoints, int waterFlowXStart, int waterFlowXEnd, int waterFlowYStart, int waterFlowYEnd)
        {
